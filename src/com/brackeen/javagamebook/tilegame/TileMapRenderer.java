        ...
        int screenWidth, int screenHeight)
    {
        ...
        while (i.hasNext()) {
            ...
            if (sprite instanceof Bullet){
            	if(x < -10 || x > screenWidth){
            		i.remove();
            	}
            }
        }
        g.drawString("Health: "+(int)p.health, 100, 200);
        g.drawString("Score: "+(int)p.score, 300, 200);
        g.drawString("Time: "+(int)p.time/1000, 500, 200);
